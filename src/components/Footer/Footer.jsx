      ...
      <div className='page-wrapper'>
        <div className=' pt-4 xl:pt-16 px-4 xl:px-0 grid grid-cols-2 xl:grid-cols-5 xl:gap-[52px]'>
          ...
          <div className='company xl:w-[165px]'>
            <h5 style={satoshi.style} className='title'>
              Company
            </h5>
          ...
          <div className='subscribe xl:w-[271px] font '>
            ...
            <p style={satoshiMedium.style} className='desc lg:mb-7 '>
              A newsletter is a tool used to communicate regularly with your
              subscribers
            </p>
            <div className='subscribe-email'>
              <input
                className='bg-[#161b28] py-[10px] pl-[15px] text-[#67738C] '
                type='email'
                name=''
                id=''
                placeholder='Enter your email'
              />
              <button className='send-btn py-[13px] px-3 '>
                <svg
